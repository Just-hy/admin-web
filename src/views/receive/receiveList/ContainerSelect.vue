<template>
    <sys-dialog :title="dialog.title" :width="800" :height="dialog.height" :visible="dialog.visible" @onClose="onClose"
        @onConfirm="onConfirm">
        <template #querys>
            <a-form-item style="width:300px;" label="父容器条码">
                <a-input v-model:value="listParm.parentSN" class="input" placeholder="请输入父容器条码"></a-input>
            </a-form-item>
            <a-form-item style="width:300px;" label="子容器条码">
                <a-input v-model:value="listParm.childSN" class="input" placeholder="请输入子容器条码"></a-input>
            </a-form-item>
